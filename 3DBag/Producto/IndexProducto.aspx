...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <h1>Productos</h1>
        <asp:Button runat="server" ID="btnAlta" OnClick="btnAlta_Click" Text="Alta" />
        <br />
        <div class="form-group">
            <div class="table-responsive">
                <asp:GridView ID="gridProducto" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="table table-bordered table-condensed table-responsive table-hover" OnRowCommand="gridProducto_RowCommand1">
